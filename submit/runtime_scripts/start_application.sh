...
if [ ! -S /home/submit/files/dbready.txt ]; then
  ...
  touch /home/submit/files/dbready.txt 
else
  echo "Found /home/submit/files/dbready.txt indicating the database is already set up, skipping database ready as it may be redundant and dangerous. If you have made changes to the database please clear out the file system and the database"
fi